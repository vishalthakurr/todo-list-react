            ...
            <div className="main-div">
                ...
                <div className="child-div">
                    ...
                    <div className="add-item">
                        <input type="text" placeholder="✍  Add Items.." size="50 " value={inputdata} onChange={(e) => setInputdata(e.target.value)} maxLength="45" />
                        {
                            tooglesub ?<i className="fa fa-plus add-btn" title="Add item" onClick={additem}></i>:
                            <i className="fa fa-edit add-btn2" title="update item" onClick={additem}></i>
